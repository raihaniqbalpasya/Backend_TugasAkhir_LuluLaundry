...
module.exports = {
  async getAll(req, res) {
    try {
      ...
      const data = await infoUmumService.getAll(perPage, start); // Data yang sudah dipaginasi
      const allData = await infoUmumService.getAllData(); // Seluruh data tanpa paginasi
